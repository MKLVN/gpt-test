...
public class JoinCustomGameResultMessage : Message
{
	...
	{
		return new JoinCustomGameResultMessage(joinGameData, success: true, CustomGameJoinResponse.Success, matchId);
	}

	public static JoinCustomGameResultMessage CreateFailed(CustomGameJoinResponse response)
	{
		return new JoinCustomGameResultMessage(null, success: false, response, null);
	}
}
