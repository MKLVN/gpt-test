...
public static class BarterHelper
{
	...
	{
		return barterables.AnyQ((Barterable x) => x is ItemBarterable itemBarterable2 && itemBarterable2.ItemRosterElement.EquipmentElement.Item == itemBarterable.ItemRosterElement.EquipmentElement.Item);
	}
