...
public static class CharacterHelper
{
	...
	public static (uint color1, uint color2) GetDeterministicColorsForCharacter(CharacterObject character)
	{
		...
		if (character.IsHero)
		{
			...
			{
				return ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), (uint)(((int?)character.HeroObject.MapFaction?.Color2) ?? (-3357781)));
			}
			return cultureObject.StringId switch
			{
				"empire" => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.EmpireHeroClothColors)), 
				"sturgia" => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.SturgiaHeroClothColors)), 
				"aserai" => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.AseraiHeroClothColors)), 
				"vlandia" => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.VlandiaHeroClothColors)), 
				"battania" => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.BattaniaHeroClothColors)), 
				"khuzait" => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.KhuzaitHeroClothColors)), 
				_ => ((uint)(((int?)character.HeroObject.MapFaction?.Color) ?? (-3357781)), GetDeterministicColorFromListForHero(character.HeroObject, CampaignData.EmpireHeroClothColors)), 
			};
		}
