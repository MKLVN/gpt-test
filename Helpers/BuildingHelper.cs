...
public static class BuildingHelper
{
	...
	public static float GetProgressOfBuilding(Building building, Town town)
	{
		...
		Debug.FailedAssert(string.Concat(building.Name, "is not a project of", town.Name), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "GetProgressOfBuilding", 6205);
		return 0f;
	}
	...
	public static int GetDaysToComplete(Building building, Town town)
	{
		...
		Debug.FailedAssert(string.Concat(building.Name, "is not a project of", town.Name), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "GetDaysToComplete", 6247);
		return 0;
	}
	...
	public static int GetTierOfBuilding(BuildingType buildingType, Town town)
	{
		...
		Debug.FailedAssert(string.Concat(buildingType.Name, "is not a project of", town.Name), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "GetTierOfBuilding", 6261);
		return 0;
	}
