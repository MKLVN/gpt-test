...
public static class MenuHelper
{
	...
	private static void EncounterOrderAttack(TroopRoster selectedTroopsForPlayerSide)
	{
		...
		PartyBase leaderParty = battle.GetLeaderParty(PartyBase.MainParty.OpponentSide);
		if (leaderParty.SiegeEvent?.BesiegerCamp != null && !leaderParty.SiegeEvent.BesiegerCamp.HasInvolvedPartyForEventType(leaderParty) && MobileParty.MainParty.BesiegerCamp == null)
		{
