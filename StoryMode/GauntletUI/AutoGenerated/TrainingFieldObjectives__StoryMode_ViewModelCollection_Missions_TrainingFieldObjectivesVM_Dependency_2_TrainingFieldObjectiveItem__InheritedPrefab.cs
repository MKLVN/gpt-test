...
public class TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_2_TrainingFieldObjectiveItem__InheritedPrefab : ListPanel
{
	...
	public TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_2_TrainingFieldObjectiveItem__InheritedPrefab(UIContext context)
		: base(context)
	{
	}
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_ObjectiveItems != null)
		{
			...
			for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
			{
				...
				((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)child).OnBeforeRemovedChild(child);
				((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)_widget_1.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_ObjectiveItemsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Reset:
		{
			for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
			{
				...
				((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)child3).OnBeforeRemovedChild(child3);
				Widget child4 = _widget_1.GetChild(num);
				((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)child4).SetDataSource(null);
		...
		{
			TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate = new TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate(base.Context);
			GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate);
			...
			trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.AddComponent(generatedWidgetData);
			_widget_1.AddChildAtIndex(trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate, e.NewIndex);
			trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.CreateWidgets();
			trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.SetIds();
			trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.SetAttributes();
			trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_1.GetChild(e.NewIndex);
			((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_1.GetChild(e.NewIndex);
			((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(TrainingFieldObjectiveItemVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			...
			if (_datasource_Root_ObjectiveItems != null)
			{
				...
				for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
				{
					...
					((TrainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate)child2).SetDataSource(null);
		...
		if (_datasource_Root_ObjectiveItems != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ObjectiveItems.Count; i++)
			{
				...
				trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1.AddChildAtIndex(trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate, i);
				trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.CreateWidgets();
				trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.SetIds();
				trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.SetAttributes();
				trainingFieldObjectives__StoryMode_ViewModelCollection_Missions_TrainingFieldObjectivesVM_Dependency_3_ItemTemplate.SetDataSource(dataSource);
