...
public class StoryModeEncounterGameMenuModel : DefaultEncounterGameMenuModel
{
	...
	{
		Settlement settlement = GetEncounteredPartyBase(attackerParty, defenderParty).Settlement;
		string text = "";
		...
		{
			text = base.GetEncounterMenu(attackerParty, defenderParty, out startBattle, out joinBattle);
		}
		return text;
	}
}
