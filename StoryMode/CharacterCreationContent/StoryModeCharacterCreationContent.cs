...
public class StoryModeCharacterCreationContent : CharacterCreationContentBase
{
	...
	{
		StoryModeHeroes.LittleBrother.Culture = GetSelectedCulture();
		StoryModeHeroes.LittleSister.Culture = GetSelectedCulture();
	}
	...
	protected void AddEscapeMenu(CharacterCreation characterCreation)
	{
		...
		CharacterCreationCategory characterCreationCategory = characterCreationMenu.AddMenuCategory();
		characterCreationCategory.AddCategoryOption(new TextObject("{=6vCHovVH}you subdued a raider."), new MBList<SkillObject>
		{
			DefaultSkills.OneHanded,
			DefaultSkills.Athletics
		}, DefaultCharacterAttributes.Vigor, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EscapeSubdueRaiderOnConsequence, EscapeSubdueRaiderOnApply, new TextObject("{=CvBoRaFv}You were able to grab a knife in the confusion of the attack. You stabbed a raider blocking your way."));
		characterCreationCategory.AddCategoryOption(new TextObject("{=2XhW49TX}you drove them off with arrows."), new MBList<SkillObject>
		{
			DefaultSkills.Bow,
			DefaultSkills.Tactics
		}, DefaultCharacterAttributes.Control, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EscapeDrawArrowsOnConsequence, EscapeDrawArrowsOnApply, new TextObject("{=ccf67J3J}You grabbed a bow and sent a few arrows the raiders' way. They took cover, giving you the opportunity to flee with your brother."));
		characterCreationCategory.AddCategoryOption(new TextObject("{=gOI8lKcl}you rode off on a fast horse."), new MBList<SkillObject>
		{
			DefaultSkills.Riding,
			DefaultSkills.Scouting
		}, DefaultCharacterAttributes.Endurance, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EscapeFastHorseOnConsequence, EscapeFastHorseOnApply, new TextObject("{=cepWNzEA}Jumping on the two remaining horses in the inn's burning stable, you and your brother broke out of the encircling raiders and rode off."));
		characterCreationCategory.AddCategoryOption(new TextObject("{=EdUppdLZ}you tricked the raiders."), new MBList<SkillObject>
		{
			DefaultSkills.Roguery,
			DefaultSkills.Tactics
		}, DefaultCharacterAttributes.Cunning, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EscapeRoadOffWithBrotherOnConsequence, EscapeRoadOffWithBrotherOnApply, new TextObject("{=ZqOvtLBM}In the confusion of the attack you shouted that someone had found treasure in the back room. You then made your way out of the undefended entrance with your brother."));
		characterCreationCategory.AddCategoryOption(new TextObject("{=qhAhPWdp}you organized the travelers to break out."), new MBList<SkillObject>
		{
			DefaultSkills.Leadership,
			DefaultSkills.Charm
		}, DefaultCharacterAttributes.Social, FocusToAdd, SkillLevelToAdd, AttributeLevelToAdd, null, EscapeOrganizeTravellersOnConsequence, EscapeOrganizeTravellersOnApply, new TextObject("{=Lmfi0cYk}You encouraged the few travellers in the inn to break out in a coordinated fashion. Raiders killed or captured most but you and your brother were able to escape."));
		characterCreation.AddNewMenu(characterCreationMenu);
	}
	...
	protected void ChangeParentsAnimation(CharacterCreation characterCreation)
	{
		...
		list.Add("anim_mother_" + base.SelectedParentType);
		list.Add("anim_father_" + base.SelectedParentType);
	...
	protected void FinalizeParents()
	{
		...
		TextObject textObject2 = new TextObject("{=h68qCoz3}{PLAYER_LITTLE_BROTHER.NAME} is the little brother of {PLAYER.LINK}. He has been abducted by bandits, who intend to sell him into slavery.");
		StringHelpers.SetCharacterProperties("PLAYER_LITTLE_BROTHER", StoryModeHeroes.LittleBrother.CharacterObject, textObject2);
		...
		TextObject textObject4 = new TextObject("{=epB0x816}{PLAYER_LITTLE_SISTER.NAME} is the little sister of {PLAYER.LINK}. She has been abducted by bandits, who intend to sell her into slavery.");
		StringHelpers.SetCharacterProperties("PLAYER_LITTLE_SISTER", StoryModeHeroes.LittleSister.CharacterObject, textObject4);
		...
		TextObject textObject6 = new TextObject("{=XmvaRfLM}{PLAYER_FATHER.NAME} was the father of {PLAYER.LINK}. He was slain when raiders attacked the inn at which his family was staying.");
		StringHelpers.SetCharacterProperties("PLAYER_FATHER", object2, textObject6);
		...
		TextObject textObject8 = new TextObject("{=hrhvEWP8}{PLAYER_MOTHER.NAME} was the mother of {PLAYER.LINK}. She was slain when raiders attacked the inn at which her family was staying.");
		StringHelpers.SetCharacterProperties("PLAYER_MOTHER", @object, textObject8);
		...
		TextObject textObject10 = new TextObject("{=bsWSecYa}{PLAYER_BROTHER.NAME} is the elder brother of {PLAYER.LINK}. He has gone in search of the family's two youngest siblings, {PLAYER_LITTLE_BROTHER.NAME} and {PLAYER_LITTLE_SISTER.NAME}.");
		StringHelpers.SetCharacterProperties("PLAYER_BROTHER", characterObject, textObject10);
		StringHelpers.SetCharacterProperties("PLAYER", CharacterObject.PlayerCharacter, textObject10);
		StringHelpers.SetCharacterProperties("PLAYER_LITTLE_BROTHER", StoryModeHeroes.LittleBrother.CharacterObject, textObject10);
		StringHelpers.SetCharacterProperties("PLAYER_LITTLE_SISTER", StoryModeHeroes.LittleSister.CharacterObject, textObject10);
	...
	protected void EscapeOnInit(CharacterCreation characterCreation)
	{
		...
		CreateSibling(StoryModeHeroes.LittleBrother);
		CreateSibling(StoryModeHeroes.LittleSister);
		...
		list.Add(new FaceGenChar(originalBodyProperties, CharacterObject.PlayerCharacter.Race, new Equipment(), CharacterObject.PlayerCharacter.IsFemale, "act_childhood_schooled"));
		...
		if (CharacterObject.PlayerCharacter.HasMount())
		{
			...
			list2.Add(new FaceGenMount(MountCreationKey.GetRandomMountKey(item, CharacterObject.PlayerCharacter.GetMountKeySeed()), CharacterObject.PlayerCharacter.Equipment[EquipmentIndex.ArmorItemEndSlot].Item, CharacterObject.PlayerCharacter.Equipment[EquipmentIndex.HorseHarness].Item));
		}
		if (elderBrother.CharacterObject.HasMount())
		{
			ItemObject item2 = elderBrother.CharacterObject.Equipment[EquipmentIndex.ArmorItemEndSlot].Item;
			list2.Add(new FaceGenMount(MountCreationKey.GetRandomMountKey(item2, elderBrother.CharacterObject.GetMountKeySeed()), elderBrother.CharacterObject.Equipment[EquipmentIndex.ArmorItemEndSlot].Item, elderBrother.CharacterObject.Equipment[EquipmentIndex.HorseHarness].Item));
		}
	}
	...
	{
		List<Equipment> list = new List<Equipment>();
		list.Add(CharacterObject.PlayerCharacter.Equipment);
		list.Add(StoryModeHeroes.ElderBrother.CharacterObject.Equipment);
		characterCreation.ChangeCharactersEquipment(list);
	}
	...
	protected void ApplyEquipments(CharacterCreation characterCreation)
	{
		...
		ApplyBrotherClothingAndEquipment();
	}

	protected void ApplyBrotherClothingAndEquipment()
	{
		MBEquipmentRoster @object = Game.Current.ObjectManager.GetObject<MBEquipmentRoster>("brother_char_creation_" + GetSelectedCulture().StringId);
		Hero elderBrother = StoryModeHeroes.ElderBrother;
		elderBrother.CharacterObject.Equipment.FillFrom(@object?.DefaultEquipment ?? MBEquipmentRoster.EmptyEquipment);
		elderBrother.CharacterObject.FirstCivilianEquipment.FillFrom(@object?.GetCivilianEquipments().FirstOrDefault() ?? MBEquipmentRoster.EmptyEquipment);
	}
