...
public class AnimatedDropdownWidget : Widget
{
	...
	private void CreateNavigationScope()
	{
		...
		{
			base.EventManager.RemoveNavigationScope(_navigationScope);
		}
		...
		base.EventManager.AddNavigationScope(_navigationScope, initialize: true);
		...
		base.EventManager.AddForcedScopeCollection(_scopeCollection);
	}
	...
	private void ClearGamepadNavigationScopeData()
	{
		...
		{
			base.EventManager.RemoveForcedScopeCollection(_scopeCollection);
		}
	}
