...
public class DefaultSkillEffects
{
	...
	public static SkillEffect HorseWeaponDamagePenalty => Instance._effectHorseWeaponDamagePenalty;

	public static SkillEffect HorseWeaponSpeedPenalty => Instance._effectHorseWeaponSpeedPenalty;
	...
	private void RegisterAll()
	{
		...
		_effectHorseWeaponDamagePenalty = Create("HorseWeaponDamagePenalty");
		_effectHorseWeaponSpeedPenalty = Create("HorseWeaponSpeedPenalty");
	...
	private void InitializeAll()
	{
		...
		_effectHorseWeaponDamagePenalty.Initialize(new TextObject("{=0dbwEczK}Mounted weapon damage penalty: {a0}%"), new SkillObject[1] { DefaultSkills.Riding }, SkillEffect.PerkRole.Personal, -0.2f, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 20f);
		_effectHorseWeaponSpeedPenalty.Initialize(new TextObject("{=oE5etyy0}Mounted weapon speed & reload penalty: {a0}%"), new SkillObject[1] { DefaultSkills.Riding }, SkillEffect.PerkRole.Personal, -0.2f, SkillEffect.PerkRole.None, 0f, SkillEffect.EffectIncrementType.Add, 20f);
