...
public static class ChangeKingdomAction
{
	...
	private static void ApplyInternal(Clan clan, Kingdom newKingdom, ChangeKingdomActionDetail detail, int awardMultiplier = 0, bool byRebellion = false, bool showNotification = true)
	{
		...
		bool thereWasAPlayerSiege = PlayerSiege.PlayerSiegeEvent != null;
		bool thereWasAPlayerMapEvent = MobileParty.MainParty.MapEvent != null;
		bool thereWasAPlayerEncounter = PlayerEncounter.Current != null;
		...
		if (detail == ChangeKingdomActionDetail.LeaveAsMercenary || detail == ChangeKingdomActionDetail.LeaveKingdom || detail == ChangeKingdomActionDetail.LeaveWithRebellion)
		{
			...
			CheckEventsAndHandleMenu(thereWasAPlayerSiege, thereWasAPlayerMapEvent, thereWasAPlayerEncounter, detail);
	...
	private static void CheckEventsAndHandleMenu(bool thereWasAPlayerSiege, bool thereWasAPlayerMapEvent, bool thereWasAPlayerEncounter, ChangeKingdomActionDetail detail)
	{
		...
		{
			Campaign.Current.GameMenuManager.SetNextMenu((detail == ChangeKingdomActionDetail.LeaveAsMercenary) ? "hostile_action_end_by_leave_kingdom_as_mercenary" : "hostile_action_end_by_peace");
			return;
		}
		object menuId;
		switch (detail)
		{
		default:
			menuId = "hostile_action_end_by_peace";
			break;
		case ChangeKingdomActionDetail.LeaveAsMercenary:
			menuId = "hostile_action_end_by_leave_kingdom_as_mercenary";
			break;
		case ChangeKingdomActionDetail.CreateKingdom:
			return;
		}
