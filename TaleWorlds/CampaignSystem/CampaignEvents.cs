...
public class CampaignEvents : CampaignEventReceiver
{
	...
	public static IMbEvent<Clan, Kingdom, Kingdom, ChangeKingdomAction.ChangeKingdomActionDetail, bool> ClanChangedKingdom => Instance._clanChangedKingdom;
	...
	public static IMbEvent<MobileParty, TroopRoster, Settlement> OnPrisonerSoldEvent => Instance._onPrisonerSoldEvent;
	...
	{
		Instance._onPrisonerSoldEvent.Invoke(party, prisoners, currentSettlement);
	}
