...
public class PartyScreenLogic
{
	...
	private List<(EquipmentElement, int)> RemoveItemFromItemRoster(ItemCategory itemCategory, int numOfItemsLeftToRemove = 1)
	{
		...
		if (numOfItemsLeftToRemove > 0)
		{
			TaleWorlds.Library.Debug.FailedAssert("Couldn't find enough upgrade req items in the inventory.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Party\\PartyScreenLogic.cs", "RemoveItemFromItemRoster", 1467);
		}
		return list;
	}
