...
public class WorkshopsCampaignBehavior : CampaignBehaviorBase, IWorkshopWarehouseCampaignBehavior
{
	...
	private void EnsureBehaviorDataSize()
	{
		if (_workshopData.Length < Campaign.Current.Models.WorkshopModel.MaximumWorkshopsPlayerCanHave)
		{
			...
			{
				array[i] = ((_workshopData[i] != null) ? _workshopData[i] : null);
			}
			_workshopData = array;
		}
		...
		{
			if (_warehouseRosterPerSettlement[j].Key != null && _warehouseRosterPerSettlement[j].Value != null)
			{
	...
	private void OnHeroKilled(Hero victim, Hero killer, KillCharacterAction.KillCharacterActionDetail detail, bool showNotification = true)
	{
		...
		{
			Hero notableOwnerForWorkshop = Campaign.Current.Models.WorkshopModel.GetNotableOwnerForWorkshop(item.Settlement);
	...
	private void BuildWorkshopsAtGameStart()
	{
		foreach (Town allTown in Town.AllTowns)
		{
			...
			{
				Hero notableOwnerForWorkshop = Campaign.Current.Models.WorkshopModel.GetNotableOwnerForWorkshop(allTown.Settlement);
