...
public class PlayerArmyWaitBehavior : CampaignBehaviorBase
{
	...
	{
		if (MobileParty.MainParty.AttachedTo != null && Campaign.Current.CurrentMenuContext?.GameMenu?.StringId == "army_wait" && MobileParty.MainParty.AttachedTo.Army.AiBehaviorObject is Settlement settlement && settlement.SiegeEvent != null && Hero.MainHero.PartyBelongedTo.Army.LeaderParty.BesiegedSettlement == settlement)
		{
