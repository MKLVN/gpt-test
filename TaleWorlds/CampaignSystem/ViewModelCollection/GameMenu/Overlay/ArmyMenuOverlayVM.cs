...
public class ArmyMenuOverlayVM : GameMenuOverlay
{
	...
	protected override void ExecuteOnSetAsActiveContextMenuItem(GameMenuPartyItemVM troop)
	{
		...
		CharacterObject character = _contextMenuItem.Character ?? _contextMenuItem.Party.LeaderHero.CharacterObject;
		CampaignEventDispatcher.Instance.OnCharacterPortraitPopUpOpened(character);
	}
	...
	private void UpdateProperties()
	{
		...
		ManCountText = CampaignUIHelper.GetPartyNameplateText(_army.LeaderParty);
