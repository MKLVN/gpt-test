...
public class DefaultPerks
{
	...
	private void InitializeAll()
	{
		...
		_craftingMasterSmith.Initialize("{=ivH8RWyb}Master Smith", DefaultSkills.Crafting, GetTierCost(8), null, "{=*}{VALUE}% greater chance of creating masterwork weapons.", SkillEffect.PerkRole.Personal, 0.075f, SkillEffect.EffectIncrementType.AddFactor);
		...
		_craftingLegendarySmith.Initialize("{=f4lnEplc}Legendary Smith", DefaultSkills.Crafting, GetTierCost(11), null, "{=*}{VALUE}% greater chance of creating Legendary weapons, chance increases by 1% for every 5 skill points above 275.", SkillEffect.PerkRole.Personal, 0.05f, SkillEffect.EffectIncrementType.AddFactor);
