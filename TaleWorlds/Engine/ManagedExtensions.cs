...
public static class ManagedExtensions
{
	...
	{
		object[] customAttributes = Managed.GetFieldOfClass(className, fieldName).GetCustomAttributes(typeof(EditorVisibleScriptComponentVariable), inherit: true);
		if (customAttributes.Length != 0)
		{
			return (customAttributes[0] as EditorVisibleScriptComponentVariable).Visible;
		}
		return true;
	}
