...
public class TacticSallyOutHitAndRun : TacticComponent
{
	...
	{
		List<IPrimarySiegeWeapon> list = _teamAISallyOutAttacker.PrimarySiegeWeapons.Where((IPrimarySiegeWeapon psw) => psw is SiegeWeapon siegeWeapon && !siegeWeapon.IsDisabled && siegeWeapon.IsDestructible).ToList();
