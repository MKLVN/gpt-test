...
public sealed class Formation : IFormation
{
	...
	public MBList<IFormationUnit> UnitsWithoutLooseDetachedOnes => Arrangement.GetAllUnits();
	...
	{
		if (unit.IsDetachedFromFormation && (_movementOrder.MovementState != 0 || !unit.Detachment.IsLoose))
		{
