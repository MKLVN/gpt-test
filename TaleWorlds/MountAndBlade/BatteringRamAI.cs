...
public sealed class BatteringRamAI : UsableMachineAIBase
{
	...
	protected override MovementOrder NextOrder
	{
		get
		{
			if (Mission.Current.Teams[0].TeamAI is TeamAISiegeComponent teamAISiegeComponent && teamAISiegeComponent.InnerGate != null && !teamAISiegeComponent.InnerGate.IsDestroyed)
			{
