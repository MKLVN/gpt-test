...
public class MultiplayerOptions
{
	...
	public enum OptionType
	{
		...
		ServerName,
		[MultiplayerOptionsProperty(OptionValueType.String, MultiplayerOptionsProperty.ReplicationOccurrence.AtMapLoad, "Welcome messages which is shown to all players when they enter the server.", 0, 0, null, false, null)]
		WelcomeMessage,
		...
		Map,
		[MultiplayerOptionsProperty(OptionValueType.String, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Sets culture for team 1", 0, 0, null, true, null)]
		CultureTeam1,
		[MultiplayerOptionsProperty(OptionValueType.String, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Sets culture for team 2", 0, 0, null, true, null)]
		CultureTeam2,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Set the maximum amount of player allowed on the server.", 1, 1023, null, false, null)]
		MaxNumberOfPlayers,
		...
		[MultiplayerOptionsProperty(OptionValueType.Enum, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Who can spectators look at, and how.", 0, 7, null, true, typeof(SpectatorCameraTypes))]
		SpectatorCamera,
		...
		WarmupTimeLimit,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Maximum duration for the map. In minutes.", 1, 60, null, false, null)]
		MapTimeLimit,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Maximum duration for each round. In seconds.", 60, 3600, new string[] { "Battle", "NewBattle", "ClassicBattle", "Captain", "Skirmish", "Siege" }, false, null)]
		RoundTimeLimit,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Time available to select class/equipment. In seconds.", 2, 60, new string[] { "Battle", "NewBattle", "ClassicBattle", "Captain", "Skirmish", "Siege" }, false, null)]
		RoundPreparationTimeLimit,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Maximum amount of rounds before the game ends.", 1, 99, new string[] { "Battle", "NewBattle", "ClassicBattle", "Captain", "Skirmish", "Siege" }, false, null)]
		RoundTotal,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Wait time after death, before respawning again. In seconds.", 1, 60, new string[] { "Siege" }, false, null)]
		RespawnPeriodTeam1,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Wait time after death, before respawning again. In seconds.", 1, 60, new string[] { "Siege" }, false, null)]
		RespawnPeriodTeam2,
		...
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Min score to win match.", 0, 1023000, new string[] { "TeamDeathmatch" }, false, null)]
		MinScoreToWinMatch,
		[MultiplayerOptionsProperty(OptionValueType.Integer, MultiplayerOptionsProperty.ReplicationOccurrence.Immediately, "Min score to win duel.", 0, 7, new string[] { "Duel" }, false, null)]
		MinScoreToWinDuel,
	...
	private class MultiplayerOptionsContainer
	{
		...
		{
			_multiplayerOptions[(int)optionType] = option;
		}
		...
		{
			CopyImmediateEffectValuesTo(other);
			CopyNewRoundValuesTo(other);
			CopyNewMapValuesTo(other);
		}

		public void CopyImmediateEffectValuesTo(MultiplayerOptionsContainer other)
		{
			other.CopyOptionFromOther(OptionType.AllowPollsToKickPlayers, GetOptionFromOptionType(OptionType.AllowPollsToKickPlayers));
			other.CopyOptionFromOther(OptionType.AllowPollsToBanPlayers, GetOptionFromOptionType(OptionType.AllowPollsToBanPlayers));
			other.CopyOptionFromOther(OptionType.AllowPollsToChangeMaps, GetOptionFromOptionType(OptionType.AllowPollsToChangeMaps));
			other.CopyOptionFromOther(OptionType.AllowIndividualBanners, GetOptionFromOptionType(OptionType.AllowIndividualBanners));
			other.CopyOptionFromOther(OptionType.UseRealisticBlocking, GetOptionFromOptionType(OptionType.UseRealisticBlocking));
			other.CopyOptionFromOther(OptionType.MaxNumberOfPlayers, GetOptionFromOptionType(OptionType.MaxNumberOfPlayers));
			other.CopyOptionFromOther(OptionType.MinNumberOfPlayersForMatchStart, GetOptionFromOptionType(OptionType.MinNumberOfPlayersForMatchStart));
			other.CopyOptionFromOther(OptionType.WarmupTimeLimit, GetOptionFromOptionType(OptionType.WarmupTimeLimit));
			other.CopyOptionFromOther(OptionType.MapTimeLimit, GetOptionFromOptionType(OptionType.MapTimeLimit));
			other.CopyOptionFromOther(OptionType.RoundTotal, GetOptionFromOptionType(OptionType.RoundTotal));
			other.CopyOptionFromOther(OptionType.RoundTimeLimit, GetOptionFromOptionType(OptionType.RoundTimeLimit));
			other.CopyOptionFromOther(OptionType.RoundPreparationTimeLimit, GetOptionFromOptionType(OptionType.RoundPreparationTimeLimit));
			other.CopyOptionFromOther(OptionType.RespawnPeriodTeam1, GetOptionFromOptionType(OptionType.RespawnPeriodTeam1));
			other.CopyOptionFromOther(OptionType.RespawnPeriodTeam2, GetOptionFromOptionType(OptionType.RespawnPeriodTeam2));
			other.CopyOptionFromOther(OptionType.UnlimitedGold, GetOptionFromOptionType(OptionType.UnlimitedGold));
			other.CopyOptionFromOther(OptionType.GoldGainChangePercentageTeam1, GetOptionFromOptionType(OptionType.GoldGainChangePercentageTeam1));
			other.CopyOptionFromOther(OptionType.GoldGainChangePercentageTeam2, GetOptionFromOptionType(OptionType.GoldGainChangePercentageTeam2));
			other.CopyOptionFromOther(OptionType.MinScoreToWinMatch, GetOptionFromOptionType(OptionType.MinScoreToWinMatch));
			other.CopyOptionFromOther(OptionType.PollAcceptThreshold, GetOptionFromOptionType(OptionType.PollAcceptThreshold));
			other.CopyOptionFromOther(OptionType.SpectatorCamera, GetOptionFromOptionType(OptionType.SpectatorCamera));
			other.CopyOptionFromOther(OptionType.NumberOfBotsTeam1, GetOptionFromOptionType(OptionType.NumberOfBotsTeam1));
			other.CopyOptionFromOther(OptionType.NumberOfBotsTeam2, GetOptionFromOptionType(OptionType.NumberOfBotsTeam2));
			other.CopyOptionFromOther(OptionType.FriendlyFireDamageMeleeSelfPercent, GetOptionFromOptionType(OptionType.FriendlyFireDamageMeleeSelfPercent));
			other.CopyOptionFromOther(OptionType.FriendlyFireDamageMeleeFriendPercent, GetOptionFromOptionType(OptionType.FriendlyFireDamageMeleeFriendPercent));
			other.CopyOptionFromOther(OptionType.FriendlyFireDamageRangedSelfPercent, GetOptionFromOptionType(OptionType.FriendlyFireDamageRangedSelfPercent));
			other.CopyOptionFromOther(OptionType.FriendlyFireDamageRangedFriendPercent, GetOptionFromOptionType(OptionType.FriendlyFireDamageRangedFriendPercent));
			other.CopyOptionFromOther(OptionType.AutoTeamBalanceThreshold, GetOptionFromOptionType(OptionType.AutoTeamBalanceThreshold));
			other.CopyOptionFromOther(OptionType.WelcomeMessage, GetOptionFromOptionType(OptionType.WelcomeMessage));
			other.CopyOptionFromOther(OptionType.GamePassword, GetOptionFromOptionType(OptionType.GamePassword));
			other.CopyOptionFromOther(OptionType.AdminPassword, GetOptionFromOptionType(OptionType.AdminPassword));
		}

		public void CopyNewRoundValuesTo(MultiplayerOptionsContainer other)
		{
			other.CopyOptionFromOther(OptionType.NumberOfBotsPerFormation, GetOptionFromOptionType(OptionType.NumberOfBotsPerFormation));
			other.CopyOptionFromOther(OptionType.CultureTeam1, GetOptionFromOptionType(OptionType.CultureTeam1));
			other.CopyOptionFromOther(OptionType.CultureTeam2, GetOptionFromOptionType(OptionType.CultureTeam2));
		}

		public void CopyNewMapValuesTo(MultiplayerOptionsContainer other)
		{
			other.CopyOptionFromOther(OptionType.Map, GetOptionFromOptionType(OptionType.Map));
			other.CopyOptionFromOther(OptionType.GameType, GetOptionFromOptionType(OptionType.GameType));
			other.CopyOptionFromOther(OptionType.PremadeMatchGameMode, GetOptionFromOptionType(OptionType.PremadeMatchGameMode));
		}
	}
	...
	private readonly MultiplayerOptionsContainer _ui;
	...
	public MultiplayerOptions()
	{
		...
		_ui = new MultiplayerOptionsContainer();
		MultiplayerOptionsContainer container = GetContainer();
		...
		if (multiplayerGameTypes.Count > 0)
		{
			...
			container.UpdateOptionValue(OptionType.GameType, multiplayerGameTypeInfo.GameType);
			container.UpdateOptionValue(OptionType.PremadeMatchGameMode, multiplayerGameTypes.First((MultiplayerGameTypeInfo info) => info.GameType == "Skirmish").GameType);
			container.UpdateOptionValue(OptionType.Map, multiplayerGameTypeInfo.Scenes.FirstOrDefault());
		}
		container.UpdateOptionValue(OptionType.CultureTeam1, MBObjectManager.Instance.GetObjectTypeList<BasicCultureObject>()[0].StringId);
		container.UpdateOptionValue(OptionType.CultureTeam2, MBObjectManager.Instance.GetObjectTypeList<BasicCultureObject>()[2].StringId);
		container.UpdateOptionValue(OptionType.MaxNumberOfPlayers, 120);
		container.UpdateOptionValue(OptionType.MinNumberOfPlayersForMatchStart, 1);
		container.UpdateOptionValue(OptionType.WarmupTimeLimit, 5);
		container.UpdateOptionValue(OptionType.MapTimeLimit, 30);
		container.UpdateOptionValue(OptionType.RoundTimeLimit, 120);
		container.UpdateOptionValue(OptionType.RoundPreparationTimeLimit, 10);
		container.UpdateOptionValue(OptionType.RoundTotal, 1);
		container.UpdateOptionValue(OptionType.RespawnPeriodTeam1, 3);
		container.UpdateOptionValue(OptionType.RespawnPeriodTeam2, 3);
		container.UpdateOptionValue(OptionType.MinScoreToWinMatch, 120000);
		container.UpdateOptionValue(OptionType.AutoTeamBalanceThreshold, 0);
		_current.CopyAllValuesTo(_next);
		_current.CopyAllValuesTo(_ui);
	}
	...
	public List<string> GetMultiplayerOptionsTextList(OptionType optionType)
	{
		...
		case OptionType.Map:
		{
			...
			}
			{
				...
				{
					list.Add(GameTexts.FindText("str_multiplayer_scene_name", item2).ToString());
				}
				return list;
			}
		}
	...
	private MultiplayerOptionsContainer GetContainer(MultiplayerOptionsAccessMode mode = MultiplayerOptionsAccessMode.CurrentMapOptions)
	{
		return mode switch
		{
			...
			MultiplayerOptionsAccessMode.MissionUIOptions => _ui, 
			_ => null, 
		};
	}
	...
	{
		_next.CopyAllValuesTo(_ui);
		_next.CopyAllValuesTo(_current);
		UpdateMbMultiplayerData();
	}

	public void InitializeOptionsFromUi()
	{
		_ui.CopyAllValuesTo(_next);
		if (Mission.Current == null)
		{
			_ui.CopyAllValuesTo(_current);
		}
		else
		{
			_ui.CopyImmediateEffectValuesTo(_current);
		}
		UpdateMbMultiplayerData();
	}
