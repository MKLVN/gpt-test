...
public static class TauntUsageManager
{
	...
	{
		foreach (XmlNode item in LoadXmlFile(ModuleHelper.GetModuleFullPath("Multiplayer") + "ModuleData/taunt_usage_sets.xml").DocumentElement.SelectNodes("taunt_usage_set"))
		{
