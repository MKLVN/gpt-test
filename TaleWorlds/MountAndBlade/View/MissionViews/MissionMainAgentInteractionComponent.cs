...
public class MissionMainAgentInteractionComponent
{
	...
	public void FocusStateCheckTick()
	{
		...
		else if (main.IsUsingGameObject && !(main.CurrentlyUsedGameObject is SpawnedItemEntity) && (agent == null || !(main.CurrentlyUsedGameObject is StandingPoint standingPoint) || !standingPoint.PlayerStopsUsingWhenInteractsWithOther))
		{
	...
	{
		if (CurrentFocusedObject is UsableMissionObject usableMissionObject)
		{
