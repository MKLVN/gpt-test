...
public class MissionEntitySelectionUIHandler : MissionView
{
	...
	private GameEntity GetCollidedEntity()
	{
		...
		{
			base.Mission.Scene.RayCastForClosestEntityOrTerrainMT(rayBegin, rayEnd, out float _, out GameEntity collidedEntity, 0.3f, BodyFlags.CommonFocusRayCastExcludeFlags);
