...
public class DeploymentMissionView : MissionView
{
	...
	{
		if (side == base.Mission.PlayerTeam.Side && base.Mission.DeploymentPlan.HasDeploymentBoundaries(base.Mission.PlayerTeam.Side, DeploymentPlanType.Initial))
		{
	...
	public override void OnDeploymentFinished()
	{
		...
		{
			if (base.Mission.DeploymentPlan.HasDeploymentBoundaries(base.Mission.PlayerTeam.Side, DeploymentPlanType.Initial))
			{
