...
public sealed class MissionNetworkComponent : MissionNetwork
{
	...
	private void HandleServerEventSetMachineTargetRotation(GameNetworkMessage baseMessage)
	{
		...
		if (Mission.MissionNetworkHelper.GetMissionObjectFromMissionObjectId(setMachineTargetRotation.UsableMachineId) is UsableMachine usableMachine && usableMachine.PilotAgent != null)
		{
