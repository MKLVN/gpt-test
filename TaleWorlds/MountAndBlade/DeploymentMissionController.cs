...
public class DeploymentMissionController : MissionLogic
{
	...
	public override void OnBehaviorInitialize()
	{
		...
		MissionBoundaryPlacer = base.Mission.GetMissionBehavior<MissionBoundaryPlacer>();
	...
	public override void OnMissionTick(float dt)
	{
		...
		if (mainAgent != null && mainAgent.Controller != Agent.ControllerType.AI)
		{
			...
			mainAgent.SetIsAIPaused(isPaused: true);
			mainAgent.SetDetachableFromFormation(value: false);
		}
