...
public sealed class Agent : DotNetObject, IAgent, IFocusable, IUsable, IFormationUnit, ITrackableBase
{
	...
	public ControllerType Controller
	{
		...
		set
		{
			...
			SetController(value);
			if (value == ControllerType.Player)
			{
	...
	public uint ClothingColor1
	{
		get
		{
			...
			TaleWorlds.Library.Debug.FailedAssert("Clothing color is not set.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\Agent.cs", "ClothingColor1", 1098);
	...
	public float GetBaseArmorEffectivenessForBodyPart(BoneBodyPartType bodyPart)
	{
		...
		case BoneBodyPartType.ShoulderRight:
			return GetAgentDrivenPropertyValue(DrivenProperty.ArmorTorso);
		default:
			TaleWorlds.Library.Debug.FailedAssert("false", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\Agent.cs", "GetBaseArmorEffectivenessForBodyPart", 2812);
			return GetAgentDrivenPropertyValue(DrivenProperty.ArmorTorso);
		}
	}
	...
	private void AfterStoppedUsingMissionObject(UsableMachine usableMachine, UsableMissionObject usedObject, UsableMissionObject movingToOrDefendingObject, bool isSuccessful, StopUsingGameObjectFlags flags)
	{
		...
		if (usedObject is StandingPoint standingPoint && standingPoint.AutoEquipWeaponsOnUseStopped && !flags.HasAnyFlag(StopUsingGameObjectFlags.DoNotWieldWeaponAfterStoppingUsingGameObject))
		{
