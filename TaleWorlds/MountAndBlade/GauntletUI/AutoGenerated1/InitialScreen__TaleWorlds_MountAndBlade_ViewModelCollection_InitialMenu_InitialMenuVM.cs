...
public class InitialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM : Widget, IGeneratedGauntletMovieRoot
{
	...
	private InitialMenuAnimControllerWidget _widget_0_0_0_0;

	private ListPanel _widget_0_0_0_1;

	private Widget _widget_0_0_0_1_0;

	private NavigationScopeTargeter _widget_0_0_0_1_1;
	...
	public void CreateWidgets()
	{
		...
		_widget_0_0_0_0 = new InitialMenuAnimControllerWidget(base.Context);
		...
		_widget_0_0_0_1_1 = new NavigationScopeTargeter(base.Context);
	...
	public void SetIds()
	{
		_widget_0_0_0_1.Id = "MyInnerPanelParent";
		_widget_0_0_0_1_2.Id = "MyInnerPanel";
	}
	...
	public void SetAttributes()
	{
		...
		_widget_0_0_0_0.OptionsList = _widget_0_0_0_1_2;
		_widget_0_0_0_0.InitialWaitTime = 0.2f;
		_widget_0_0_0_0.WaitTimeBetweenOptions = 0.1f;
		_widget_0_0_0_0.OptionFadeInTime = 0.2f;
		_widget_0_0_0_0.IsAnimEnabled = false;
		...
		_widget_0_0_0_1_0.SuggestedWidth = 380f;
		_widget_0_0_0_1_0.SuggestedHeight = 103f;
		...
		_widget_0_0_0_1_0.MarginTop = 100f;
		_widget_0_0_0_1_0.Sprite = base.Context.SpriteData.GetSprite("General\\InitialMenu\\main_menu_logo");
		_widget_0_0_0_1_1.ScopeID = "InitialScreen";
		_widget_0_0_0_1_1.ScopeParent = _widget_0_0_0_1_2;
		_widget_0_0_0_1_1.ScopeMovements = GamepadNavigationTypes.Vertical;
		_widget_0_0_0_1_1.HasCircularMovement = true;
		_widget_0_0_0_1_2.WidthSizePolicy = SizePolicy.CoverChildren;
		_widget_0_0_0_1_2.HeightSizePolicy = SizePolicy.CoverChildren;
		_widget_0_0_0_1_2.MinHeight = 630f;
		_widget_0_0_0_1_2.HorizontalAlignment = HorizontalAlignment.Center;
		_widget_0_0_0_1_2.VerticalAlignment = VerticalAlignment.Top;
		_widget_0_0_0_1_2.MarginTop = 65f;
		_widget_0_0_0_1_2.MarginBottom = 15f;
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_MenuOptions != null)
		{
			...
			for (int num = _widget_0_0_0_1_2.ChildCount - 1; num >= 0; num--)
			{
				...
				((InitialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate)_widget_0_0_0_1_2.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_MenuOptionsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_0_1_2.AddChildAtIndex(initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(InitialMenuVM newDataSource)
	{
		...
		if (_datasource_Root_MenuOptions != null)
		{
			...
			for (int i = 0; i < _datasource_Root_MenuOptions.Count; i++)
			{
				...
				initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_0_1_2.AddChildAtIndex(initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate, i);
				initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate.CreateWidgets();
				initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate.SetIds();
				initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate.SetAttributes();
				initialScreen__TaleWorlds_MountAndBlade_ViewModelCollection_InitialMenu_InitialMenuVM_Dependency_1_ItemTemplate.SetDataSource(dataSource);
