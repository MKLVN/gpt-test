...
public class GauntletChatLogView : GlobalLayer
{
	...
	private void HandleInput()
	{
		...
		if (ScreenManager.FocusedLayer is GauntletLayer gauntletLayer && gauntletLayer != base.Layer && gauntletLayer._gauntletUIContext.EventManager.FocusedWidget is EditableTextWidget)
		{
			inputEnabled = false;
		}
		bool flag2 = false;
		...
		if ((flag2 || flag3) && ScreenManager.TopScreen is MissionScreen missionScreen2 && missionScreen2.SceneLayer != null)
		{
