...
public class InventoryScreenWidget : Widget
{
	...
	private void UpdateControllerTransferKeyVisuals()
	{
		...
		if (base.EventManager.IsControllerActive && IsFocusedOnItemList)
		{
			...
			if (_currentHoveredItemWidget is InventoryItemTupleWidget inventoryItemTupleWidget && inventoryItemTupleWidget.IsHovered && inventoryItemTupleWidget.IsTransferable)
			{
