...
public class MultiplayerArmoryPageWidget : Widget
{
	...
	private bool IsWidgetUsedForTauntSelection(Widget widget)
	{
		...
		if (widget is MultiplayerLobbyArmoryCosmeticItemButtonWidget multiplayerLobbyArmoryCosmeticItemButtonWidget && multiplayerLobbyArmoryCosmeticItemButtonWidget.IsSelected)
		{
			return true;
		}
		return false;
