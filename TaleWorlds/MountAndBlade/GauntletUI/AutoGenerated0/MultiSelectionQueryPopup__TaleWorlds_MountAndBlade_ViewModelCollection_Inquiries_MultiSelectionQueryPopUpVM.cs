...
public class MultiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM : Widget, IGeneratedGauntletMovieRoot
{
	...
	private ListPanel _widget_0_1_3;

	private ScrollablePanel _widget_0_1_3_0;

	private NavigationScopeTargeter _widget_0_1_3_0_0;

	private MultiSelectionElementsWidget _widget_0_1_3_0_1;

	private NavigatableListPanel _widget_0_1_3_0_1_0;

	private Widget _widget_0_1_3_0_1_1;

	private ScrollbarWidget _widget_0_1_3_1;

	private Widget _widget_0_1_3_1_0;

	private ImageWidget _widget_0_1_3_1_1;

	private MultiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_2_Standard_VerticalScrollbar__DependendPrefab _widget_0_1_3_2;
	...
	public void CreateWidgets()
	{
		...
		_widget_0_1_3 = new ListPanel(base.Context);
		_widget_0_1.AddChild(_widget_0_1_3);
		_widget_0_1_3_0 = new ScrollablePanel(base.Context);
		_widget_0_1_3.AddChild(_widget_0_1_3_0);
		_widget_0_1_3_0_0 = new NavigationScopeTargeter(base.Context);
		_widget_0_1_3_0.AddChild(_widget_0_1_3_0_0);
		_widget_0_1_3_0_1 = new MultiSelectionElementsWidget(base.Context);
		_widget_0_1_3_0.AddChild(_widget_0_1_3_0_1);
		_widget_0_1_3_0_1_0 = new NavigatableListPanel(base.Context);
		_widget_0_1_3_0_1.AddChild(_widget_0_1_3_0_1_0);
		_widget_0_1_3_0_1_1 = new Widget(base.Context);
		_widget_0_1_3_0_1.AddChild(_widget_0_1_3_0_1_1);
		_widget_0_1_3_1 = new ScrollbarWidget(base.Context);
		_widget_0_1_3.AddChild(_widget_0_1_3_1);
		_widget_0_1_3_1_0 = new Widget(base.Context);
		_widget_0_1_3_1.AddChild(_widget_0_1_3_1_0);
		_widget_0_1_3_1_1 = new ImageWidget(base.Context);
		_widget_0_1_3_1.AddChild(_widget_0_1_3_1_1);
		_widget_0_1_3_2 = new MultiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_2_Standard_VerticalScrollbar__DependendPrefab(base.Context);
		_widget_0_1_3.AddChild(_widget_0_1_3_2);
		_widget_0_1_3_2.CreateWidgets();
	...
	public void SetIds()
	{
		...
		_widget_0_1_3_0_1.Id = "ClipRect";
		_widget_0_1_3_0_1_0.Id = "InquiryElementsList";
		_widget_0_1_3_1.Id = "VerticalScrollbar";
		_widget_0_1_3_1_1.Id = "VerticalScrollbarHandle";
		_widget_0_1_3_2.SetIds();
		_widget_0_1_3_2.Id = "Scrollbar";
	...
	public void SetAttributes()
	{
		...
		_widget_0_1_3.HeightSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3.SuggestedWidth = 485f;
		_widget_0_1_3.MarginBottom = 100f;
		_widget_0_1_3.HorizontalAlignment = HorizontalAlignment.Center;
		_widget_0_1_3.Sprite = base.Context.SpriteData.GetSprite("scrollable_field_9");
		...
		_widget_0_1_3_0.MarginLeft = 0f;
		_widget_0_1_3_0.MarginRight = 0f;
		_widget_0_1_3_0.AutoHideScrollBars = true;
		_widget_0_1_3_0.ClipRect = _widget_0_1_3_0_1;
		_widget_0_1_3_0.InnerPanel = _widget_0_1_3_0_1_0;
		_widget_0_1_3_0.VerticalScrollbar = _widget_0_1_3_1;
		_widget_0_1_3_0_0.ScopeID = "MultiSelectionQueryPopupItemsScope";
		_widget_0_1_3_0_0.ScopeParent = _widget_0_1_3_0_1;
		_widget_0_1_3_0_0.ScopeMovements = GamepadNavigationTypes.Vertical;
		_widget_0_1_3_0_1.WidthSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_0_1.HeightSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_0_1.MarginTop = 15f;
		_widget_0_1_3_0_1.ClipContents = true;
		_widget_0_1_3_0_1.DoneButtonWidget = _widget_0_4;
		_widget_0_1_3_0_1_0.WidthSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_0_1_0.HeightSizePolicy = SizePolicy.CoverChildren;
		_widget_0_1_3_0_1_0.StackLayout.LayoutMethod = LayoutMethod.VerticalBottomToTop;
		_widget_0_1_3_0_1_1.WidthSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_0_1_1.HeightSizePolicy = SizePolicy.Fixed;
		_widget_0_1_3_0_1_1.SuggestedHeight = 108f;
		_widget_0_1_3_0_1_1.VerticalAlignment = VerticalAlignment.Bottom;
		_widget_0_1_3_0_1_1.MarginLeft = 4f;
		_widget_0_1_3_0_1_1.MarginRight = 4f;
		_widget_0_1_3_0_1_1.Sprite = base.Context.SpriteData.GetSprite("StdAssets\\Popup\\scrollable_field_gradient");
		_widget_0_1_3_0_1_1.IsEnabled = false;
		_widget_0_1_3_1.WidthSizePolicy = SizePolicy.Fixed;
		_widget_0_1_3_1.HeightSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_1.SuggestedWidth = 8f;
		_widget_0_1_3_1.HorizontalAlignment = HorizontalAlignment.Right;
		_widget_0_1_3_1.VerticalAlignment = VerticalAlignment.Top;
		_widget_0_1_3_1.MarginRight = 15f;
		_widget_0_1_3_1.MarginTop = 18f;
		_widget_0_1_3_1.MarginBottom = 10f;
		_widget_0_1_3_1.AlignmentAxis = AlignmentAxis.Vertical;
		_widget_0_1_3_1.Handle = _widget_0_1_3_1_1;
		_widget_0_1_3_1.MaxValue = 100f;
		_widget_0_1_3_1.MinValue = 0f;
		_widget_0_1_3_1_0.WidthSizePolicy = SizePolicy.Fixed;
		_widget_0_1_3_1_0.HeightSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_1_0.SuggestedWidth = 4f;
		_widget_0_1_3_1_0.HorizontalAlignment = HorizontalAlignment.Center;
		_widget_0_1_3_1_0.Sprite = base.Context.SpriteData.GetSprite("BlankWhiteSquare_9");
		_widget_0_1_3_1_0.Color = new Color(0.3529412f, 0.2509804f, 0.2f);
		_widget_0_1_3_1_0.AlphaFactor = 0.5f;
		_widget_0_1_3_1_1.WidthSizePolicy = SizePolicy.Fixed;
		_widget_0_1_3_1_1.HeightSizePolicy = SizePolicy.Fixed;
		_widget_0_1_3_1_1.SuggestedHeight = 10f;
		_widget_0_1_3_1_1.SuggestedWidth = 10f;
		_widget_0_1_3_1_1.HorizontalAlignment = HorizontalAlignment.Center;
		_widget_0_1_3_1_1.Brush = base.Context.GetBrush("FaceGen.Scrollbar.Handle");
		_widget_0_1_3_2.SetAttributes();
		_widget_0_1_3_2.HeightSizePolicy = SizePolicy.StretchToParent;
		_widget_0_1_3_2.HorizontalAlignment = HorizontalAlignment.Right;
	...
	public void DestroyDataSource()
	{
		...
		_widget_0_1_3_2.DestroyDataSource();
		...
		if (_datasource_Root_InquiryElements != null)
		{
			...
			for (int num = _widget_0_1_3_0_1_0.ChildCount - 1; num >= 0; num--)
			{
				Widget child = _widget_0_1_3_0_1_0.GetChild(num);
				...
				((MultiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate)_widget_0_1_3_0_1_0.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_InquiryElementsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Reset:
		{
			for (int num = _widget_0_1_3_0_1_0.ChildCount - 1; num >= 0; num--)
			{
				Widget child3 = _widget_0_1_3_0_1_0.GetChild(num);
				...
				Widget child4 = _widget_0_1_3_0_1_0.GetChild(num);
				...
				_widget_0_1_3_0_1_0.RemoveChild(child4);
			}
			break;
		}
		case TaleWorlds.Library.ListChangedType.Sorted:
		{
			for (int i = 0; i < _datasource_Root_InquiryElements.Count; i++)
			{
				...
				_widget_0_1_3_0_1_0.FindChild((Widget widget) => widget.GetComponent<GeneratedWidgetData>().Data == bindingObject).SetSiblingIndex(i);
			}
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_1_3_0_1_0.AddChildAtIndex(multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate, e.NewIndex);
		...
		{
			Widget child2 = _widget_0_1_3_0_1_0.GetChild(e.NewIndex);
		...
		{
			Widget child = _widget_0_1_3_0_1_0.GetChild(e.NewIndex);
			...
			_widget_0_1_3_0_1_0.RemoveChild(child);
			break;
		}
	...
	private void RefreshDataSource_datasource_Root(MultiSelectionQueryPopUpVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			_widget_0_1_3_2.SetDataSource(null);
			_datasource_Root.PropertyChanged -= ViewModelPropertyChangedListenerOf_datasource_Root;
			_datasource_Root.PropertyChangedWithValue -= ViewModelPropertyChangedWithValueListenerOf_datasource_Root;
			_datasource_Root.PropertyChangedWithBoolValue -= ViewModelPropertyChangedWithBoolValueListenerOf_datasource_Root;
			_datasource_Root.PropertyChangedWithIntValue -= ViewModelPropertyChangedWithIntValueListenerOf_datasource_Root;
			...
			if (_datasource_Root_InquiryElements != null)
			{
				...
				for (int num = _widget_0_1_3_0_1_0.ChildCount - 1; num >= 0; num--)
				{
					Widget child = _widget_0_1_3_0_1_0.GetChild(num);
					((MultiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate)child).OnBeforeRemovedChild(child);
					Widget child2 = _widget_0_1_3_0_1_0.GetChild(num);
					...
					_widget_0_1_3_0_1_0.RemoveChild(child2);
				}
				_datasource_Root_InquiryElements = null;
			}
			if (_datasource_Root_DoneInputKey != null)
		...
		if (_datasource_Root_InquiryElements != null)
		{
			...
			for (int i = 0; i < _datasource_Root_InquiryElements.Count; i++)
			{
				...
				multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_1_3_0_1_0.AddChildAtIndex(multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate, i);
				multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate.CreateWidgets();
				multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate.SetIds();
				multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate.SetAttributes();
				multiSelectionQueryPopup__TaleWorlds_MountAndBlade_ViewModelCollection_Inquiries_MultiSelectionQueryPopUpVM_Dependency_1_ItemTemplate.SetDataSource(dataSource);
		...
		_widget_0_1_3_2.SetDataSource(_datasource_Root);
	}
