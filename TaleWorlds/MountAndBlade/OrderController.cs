...
public class OrderController
{
	...
	private void SelectFormation(Formation formation, Agent selectorAgent)
	{
		...
		{
			TaleWorlds.Library.Debug.FailedAssert("Formation already selected or is not selectable", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SelectFormation", 205);
		}
	}
	...
	public void DeselectFormation(Formation formation)
	{
		...
		{
			TaleWorlds.Library.Debug.FailedAssert("Trying to deselect an unselected formation", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "DeselectFormation", 231);
		}
	}
	...
	public void SetOrder(OrderType orderType)
	{
		...
		case OrderType.FormWider:
			...
			break;
		default:
			TaleWorlds.Library.Debug.FailedAssert("[DEBUG]Invalid order type.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrder", 631);
			break;
		}
		AfterSetOrder(orderType);
		if (this.OnOrderIssued != null)
		{
			this.OnOrderIssued(orderType, SelectedFormations);
		}
	}
	...
	private static void PlayOrderGestures(OrderType orderType, Agent agent, MBList<Formation> selectedFormations)
	{
		...
		case WeaponClass.Bow:
			...
			break;
		default:
			TaleWorlds.Library.Debug.FailedAssert("Unexpected weapon class.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "PlayOrderGestures", 808);
			break;
	...
	private static void PlayFormationSelectedGesture(Formation formation, Agent agent)
	{
		...
		case FormationClass.HorseArcher:
			...
			break;
		default:
			TaleWorlds.Library.Debug.FailedAssert("false", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "PlayFormationSelectedGesture", 844);
			break;
		}
	}
	...
	public void SetOrderWithAgent(OrderType orderType, Agent agent)
	{
		...
		case OrderType.GuardMe:
			...
			break;
		default:
			TaleWorlds.Library.Debug.FailedAssert("[DEBUG]Invalid order type.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrderWithAgent", 939);
			break;
		}
		AfterSetOrder(orderType);
		this.OnOrderIssued?.Invoke(orderType, SelectedFormations, agent);
	}
	...
	public void SetOrderWithPosition(OrderType orderType, WorldPosition orderPosition)
	{
		...
		default:
			TaleWorlds.Library.Debug.FailedAssert("[DEBUG]Invalid order type.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrderWithPosition", 989);
			break;
		}
		AfterSetOrder(orderType);
		if (this.OnOrderIssued != null)
		{
			this.OnOrderIssued(orderType, SelectedFormations, orderPosition);
		}
	}
	...
	public void SetOrderWithFormation(OrderType orderType, Formation orderFormation)
	{
		...
		case OrderType.Advance:
			...
			break;
		default:
			TaleWorlds.Library.Debug.FailedAssert("Invalid order type", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrderWithFormation", 1032);
			break;
		}
		AfterSetOrder(orderType);
		if (this.OnOrderIssued != null)
		{
			this.OnOrderIssued(orderType, SelectedFormations, orderFormation);
		}
	}
	...
	public void SetOrderWithFormationAndPercentage(OrderType orderType, Formation orderFormation, float percentage)
	{
		...
		TaleWorlds.Library.Debug.FailedAssert("Invalid order type", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrderWithFormationAndPercentage", 1073);
		AfterSetOrder(orderType);
		if (this.OnOrderIssued != null)
		{
			this.OnOrderIssued(orderType, SelectedFormations, orderFormation, percentage);
		}
	}
	...
	public void TransferUnitWithPriorityFunction(Formation orderFormation, int number, bool hasShield, bool hasSpear, bool hasThrown, bool isHeavy, bool isRanged, bool isMounted, bool excludeBannerman, List<Agent> excludedAgents)
	{
		...
		if (list != null)
		{
			...
			this.OnOrderIssued(OrderType.Transfer, SelectedFormations, orderFormation, array);
		}
		else
		{
			this.OnOrderIssued(OrderType.Transfer, SelectedFormations, orderFormation, number);
		}
	...
	public void SetOrderWithFormationAndNumber(OrderType orderType, Formation orderFormation, int number)
	{
		...
		{
			TaleWorlds.Library.Debug.FailedAssert("[DEBUG]Invalid order type.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrderWithFormationAndNumber", 1322);
		}
		AfterSetOrder(orderType);
		if (this.OnOrderIssued == null)
		{
		...
		if (list != null)
		{
			...
			this.OnOrderIssued(orderType, SelectedFormations, orderFormation, array);
		}
		else
		{
			this.OnOrderIssued(orderType, SelectedFormations, orderFormation, number);
		}
	}
	...
	public void SetOrderWithTwoPositions(OrderType orderType, WorldPosition position1, WorldPosition position2)
	{
		...
		if ((uint)(orderType - 2) <= 1u)
		{
			...
			if (enumerable.Any())
			{
				MoveToLineSegment(enumerable, simulationFormations, position1, position2, this.OnOrderIssued, actualWidths, actualUnitSpacings, isFormationLayoutVertical);
			}
		}
		else
		{
			TaleWorlds.Library.Debug.FailedAssert("Invalid order type.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "SetOrderWithTwoPositions", 1378);
		}
		AfterSetOrder(orderType);
		if (this.OnOrderIssued != null)
		{
			this.OnOrderIssued(orderType, SelectedFormations, position1, position2);
		}
	}
	...
	public void SetOrderWithOrderableObject(IOrderable target)
	{
		...
		case OrderType.MoveToLineSegment:
		{
			...
			if (enumerable2.Any())
			{
				MoveToLineSegment(TargetLineSegmentBegin: new WorldPosition(_mission.Scene, UIntPtr.Zero, globalPosition3, hasValidZ: false), TargetLineSegmentEnd: new WorldPosition(_mission.Scene, UIntPtr.Zero, globalPosition4, hasValidZ: false), formations: enumerable2, simulationFormations: simulationFormations, OnOrderIssued: this.OnOrderIssued, actualWidths: actualWidths, actualUnitSpacings: actualUnitSpacings);
			}
			break;
		}
		case OrderType.MoveToLineSegmentWithHorizontalLayout:
		{
			...
			if (enumerable.Any())
			{
				MoveToLineSegment(TargetLineSegmentBegin: new WorldPosition(_mission.Scene, UIntPtr.Zero, globalPosition, hasValidZ: false), TargetLineSegmentEnd: new WorldPosition(_mission.Scene, UIntPtr.Zero, globalPosition2, hasValidZ: false), formations: enumerable, simulationFormations: simulationFormations, OnOrderIssued: this.OnOrderIssued, actualWidths: actualWidths, actualUnitSpacings: actualUnitSpacings, isFormationLayoutVertical: false);
			}
			break;
		}
		...
		AfterSetOrder(order);
		this.OnOrderIssued?.Invoke(order, SelectedFormations, target);
	}
	...
	public static OrderType GetActiveMovementOrderOf(Formation formation)
	{
		...
		default:
			TaleWorlds.Library.Debug.FailedAssert("false", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "GetActiveMovementOrderOf", 1541);
	...
	public void SimulateDestinationFrames(out List<WorldPosition> simulationAgentFrames, float minDistance = 3f)
	{
		...
		foreach (Formation item in selectedFormations)
		{
			item.ApplyActionOnEachUnit(delegate(Agent agent, List<WorldPosition> localSimulationAgentFrames)
			{
				...
				if (position.IsValid && agent.Position.AsVec2.DistanceSquared(position.AsVec2) >= minDistanceSq)
				{
		...
		foreach (var item6 in formationChanges)
		{
			...
			if (!isLineShort)
			{
				...
				if (OnOrderIssued != null)
				{
					...
					OnOrderIssued(OrderType.Move, appliedFormations, item4);
					OnOrderIssued(OrderType.LookAtDirection, appliedFormations, item5);
					OnOrderIssued(OrderType.FormCustom, appliedFormations, item3);
				}
				continue;
			}
			...
			case OrderType.LookAtEnemy:
				...
				if (OnOrderIssued != null)
				{
					...
					OnOrderIssued(OrderType.Move, appliedFormations3, item4);
					OnOrderIssued(OrderType.LookAtEnemy, appliedFormations3);
				}
				break;
			case OrderType.LookAtDirection:
				item.SetMovementOrder(MovementOrder.MovementOrderMove(item4));
				...
				if (OnOrderIssued != null)
				{
					...
					OnOrderIssued(OrderType.Move, appliedFormations2, item4);
					OnOrderIssued(OrderType.LookAtDirection, appliedFormations2, formation.Direction);
				}
				break;
			default:
				TaleWorlds.Library.Debug.FailedAssert("false", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "MoveToLineSegment", 2359);
				break;
			}
		}
	}
	...
	public static Vec2 GetOrderLookAtDirection(IEnumerable<Formation> formations, Vec2 target)
	{
		if (!formations.Any())
		{
			TaleWorlds.Library.Debug.FailedAssert("false", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade\\AI\\OrderController.cs", "GetOrderLookAtDirection", 2379);
			return Vec2.One;
		}
		Formation formation = formations.MaxBy((Formation f) => f.CountOfUnitsWithoutDetachedOnes);
	...
	public void TransferUnits(Formation source, Formation target, int count)
	{
		...
		this.OnOrderIssued?.Invoke(OrderType.Transfer, new MBList<Formation> { source }, target, count);
	}
		...
		while (count > 1)
		{
			...
			for (int i = 0; i < 8; i++)
			{
				...
				if (formation2.CountOfUnits == 0)
				{
					...
					list.Add(formation2);
					this.OnOrderIssued?.Invoke(OrderType.Transfer, new MBList<Formation> { formation }, formation2, num);
					break;
				}
			}
			count--;
