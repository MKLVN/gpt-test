...
public class SiegeDeploymentMissionController : DeploymentMissionController
{
	...
	{
		_siegeDeploymentHandler.RemoveAllBoundaries();
		_siegeDeploymentHandler.SetDeploymentBoundary(side);
	...
	protected void OnSiegeSideDeploymentFinished(BattleSideEnum side)
	{
		...
		_siegeDeploymentHandler.RemoveAllBoundaries();
		MissionBoundaryPlacer.AddBoundaries();
	}

	public override void OnBeforeDeploymentFinished()
	{
		OnSiegeSideDeploymentFinished(base.Mission.PlayerTeam.Side);
	}
