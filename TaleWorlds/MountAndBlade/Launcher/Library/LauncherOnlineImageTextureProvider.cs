...
public class LauncherOnlineImageTextureProvider : TextureProvider
{
	...
	public LauncherOnlineImageTextureProvider()
	{
		...
		_onlineImageCacheFolderPath = folderPath + "/Mount and Blade II Bannerlord/Online Images/";
	...
	public override void Tick(float dt)
	{
		...
		if (_requiresRetry)
		{
			if (_retryCount > 10)
			{
				Debug.FailedAssert("Couldn't download " + _onlineSourceUrl, "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Launcher.Library\\LauncherOnlineImageTextureProvider.cs", "Tick", 61);
	...
	private void PopulateOnlineImageCache()
	{
		if (Directory.Exists(_onlineImageCacheFolderPath))
		{
			string[] files = Directory.GetFiles(_onlineImageCacheFolderPath, "*.png");
