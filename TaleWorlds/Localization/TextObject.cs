...
public class TextObject
{
	...
	public override string ToString()
	{
		try
		{
			return MBTextManager.ProcessTextToString(this, shouldClear: true);
		}
		catch (Exception ex)
		{
			string result = "Error at id: " + GetID() + ". Lang: " + MBTextManager.ActiveTextLanguage;
	...
	public string ToStringWithoutClear()
	{
		try
		{
			return MBTextManager.ProcessTextToString(this, shouldClear: false);
		}
		catch (Exception ex)
		{
			string result = "Error at id: " + GetID() + ". Lang: " + MBTextManager.ActiveTextLanguage;
