...
public sealed class ItemObject : MBObjectBase
{
	...
	public override void Deserialize(MBObjectManager objectManager, XmlNode node)
	{
		...
		if (node.Name == "CraftedItem")
		{
			...
			{
				TaleWorlds.Library.Debug.FailedAssert("Crafted item: " + itemObject.StringId + " can not be initialized, item replaced with Trash item.", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "Deserialize", 418);
		...
		else
		{
					...
					foreach (XmlNode childNode3 in childNode2.ChildNodes)
					{
						if (childNode3.NodeType != XmlNodeType.Comment)
						{
							...
							case "Trade":
								...
								break;
							case "Food":
								TaleWorlds.Library.Debug.FailedAssert("FoodComponent tag has been converted to TradeComponent. Use Trade xml node type", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "Deserialize", 667);
								itemComponent = null;
								break;
							case "Banner":
			...
			{
				TaleWorlds.Library.Debug.FailedAssert(string.Concat("Banner item with name: ", Name, " is not properly set. It must either be a campaign banner or it must have a banner component."), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "Deserialize", 729);
			...
			if (xmlAttribute9 != null)
			{
				...
				if (array2.Length == 3)
				{
					...
					{
						TaleWorlds.Library.Debug.FailedAssert("[DEBUG]Throw Base Offset is not valid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "Deserialize", 756);
					}
				}
				else
				{
	...
	private void MakeSureProperFlagsSetForOneAndTwoHandedWeapons()
	{
		if (PrimaryWeapon != null)
		{
			...
			{
				TaleWorlds.Library.Debug.FailedAssert(string.Concat(Name, ": Two Handed Item does not have NotUsableWithOneHand flag!"), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "MakeSureProperFlagsSetForOneAndTwoHandedWeapons", 931);
			...
			{
				TaleWorlds.Library.Debug.FailedAssert(string.Concat(Name, ": Two Handed Item does not have TwoHandIdleOnMount flag!"), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "MakeSureProperFlagsSetForOneAndTwoHandedWeapons", 940);
			...
			{
				TaleWorlds.Library.Debug.FailedAssert(string.Concat(Name, ": One Handed Item has TwoHanded flag!"), "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.Core\\ItemObject.cs", "MakeSureProperFlagsSetForOneAndTwoHandedWeapons", 949);
				PrimaryWeapon.WeaponFlags &= ~WeaponFlags.NotUsableWithOneHand;
			}
		}
	}
