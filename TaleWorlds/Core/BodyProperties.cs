...
public struct BodyProperties
{
	...
	public override string ToString()
	{
		...
		DynamicBodyProperties dynamicBodyProperties = _dynamicBodyProperties;
		mBStringBuilder.Append(dynamicBodyProperties.ToString() + " ");
		StaticBodyProperties staticBodyProperties = _staticBodyProperties;
		mBStringBuilder.Append(staticBodyProperties.ToString());
