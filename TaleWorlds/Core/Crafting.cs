...
public class Crafting
{
	...
	public void SetCraftedWeaponName(string name)
	{
		...
		{
			CraftedWeaponName = new TextObject("{=!}" + name);
			CurrentWeaponDesign = new WeaponDesign(CurrentWeaponDesign.Template, CraftedWeaponName, CurrentWeaponDesign.UsedPieces);
		}
	}
