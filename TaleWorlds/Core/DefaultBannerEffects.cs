...
public class DefaultBannerEffects
{
	...
	private void InitializeAll()
	{
		...
		_increasedMeleeDamageAgainstMountedTroops.Initialize("{=*}Increased Melee Damage Against Mounted Troops", "{=*}{BONUS_AMOUNT}% melee damage by troops in your formation against cavalry.", 0.1f, 0.2f, 0.3f, BannerEffect.EffectIncrementType.AddFactor);
