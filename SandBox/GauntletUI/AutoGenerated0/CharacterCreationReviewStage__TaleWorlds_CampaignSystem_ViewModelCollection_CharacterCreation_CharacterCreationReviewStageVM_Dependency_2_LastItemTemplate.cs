...
public class CharacterCreationReviewStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_CharacterCreationReviewStageVM_Dependency_2_LastItemTemplate : ListPanel
{
	...
	public void CreateWidgets()
	{
		...
		_widget_1_1_0 = new RichTextWidget(base.Context);
		_widget_1_1.AddChild(_widget_1_1_0);
		_widget_1_1_1 = new RichTextWidget(base.Context);
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_ImageIdentifier(string propertyName)
	{
		...
		case "Id":
			...
			break;
		case "ImageTypeCode":
			_widget_1_0.ImageTypeCode = _datasource_Root_ImageIdentifier.ImageTypeCode;
			break;
		}
	}
