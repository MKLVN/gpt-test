...
public class SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_7_GameMenuPartyItem__InheritedPrefab : GameMenuPartyItemButtonWidget
{
	...
	public SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_7_GameMenuPartyItem__InheritedPrefab(UIContext context)
		: base(context)
	{
	}
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int num = _widget_0_3.ChildCount - 1; num >= 0; num--)
			{
				...
				((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate)_widget_0_3.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_QuestsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_3.AddChildAtIndex(settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(GameMenuPartyItemVM newDataSource)
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Quests.Count; i++)
			{
				...
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_3.AddChildAtIndex(settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate, i);
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate.CreateWidgets();
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate.SetIds();
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate.SetAttributes();
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_11_ItemTemplate.SetDataSource(dataSource);
