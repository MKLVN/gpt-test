...
public class Tournament__SandBox_ViewModelCollection_Tournament_TournamentVM_Dependency_9_Tournament_Participant__DependendPrefab : Widget
{
	...
	{
		VisualDefinition visualDefinition = new VisualDefinition("TournamentParticipant", 0.2f, 0f, easeIn: false);
	...
	{
		VisualDefinition visualDefinition = new VisualDefinition("TournamentParticipantChild", 0.4f, 0.2f, easeIn: false);
		visualDefinition.AddVisualState(new VisualState("Dead")
		{
			SuggestedHeight = 0f
		});
	...
	{
		VisualDefinition visualDefinition = new VisualDefinition("TournamentParticipantParent", 0.4f, 0.2f, easeIn: false);
		visualDefinition.AddVisualState(new VisualState("Dead")
		{
			MarginTop = 0f,
			MarginBottom = 0f
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_Visual(string propertyName)
	{
		...
		case "AdditionalArgs":
			...
			break;
		case "ImageTypeCode":
			_widget_0_0_0.ImageTypeCode = _datasource_Root_Visual.ImageTypeCode;
			break;
		}
	}
