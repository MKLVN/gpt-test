...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_47_ItemTemplate : TextWidget
{
	private TextWidget _widget;

	private CraftingPerkVM _datasource_Root;

	public Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_47_ItemTemplate(UIContext context)
		: base(context)
	{
	}
