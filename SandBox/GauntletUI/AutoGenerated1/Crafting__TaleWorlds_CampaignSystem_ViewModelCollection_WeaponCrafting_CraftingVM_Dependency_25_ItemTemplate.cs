...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_25_ItemTemplate : ButtonWidget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_Yield != null)
		{
			...
			for (int num = _widget_2.ChildCount - 1; num >= 0; num--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate)_widget_2.GetChild(num)).DestroyDataSource();
			}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_Visual(string propertyName)
	{
		...
		case "Id":
			...
			break;
		case "ImageTypeCode":
			_widget_0_0.ImageTypeCode = _datasource_Root_Visual.ImageTypeCode;
			break;
		}
	}
	...
	public void OnList_datasource_Root_YieldChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate, e.NewIndex);
			...
			crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_2.GetChild(e.NewIndex);
			((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_2.GetChild(e.NewIndex);
			((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(SmeltingItemVM newDataSource)
	{
		...
		if (_datasource_Root_Yield != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Yield.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_42_ItemTemplate.SetDataSource(dataSource);
