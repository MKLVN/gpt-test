...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_22_CraftingPieceGrid__DependendPrefab : Widget
{
	...
	public Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_22_CraftingPieceGrid__DependendPrefab(UIContext context)
		: base(context)
	{
	}
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_HandlePieceList != null)
		{
			_datasource_Root_HandlePieceList.PropertyChanged -= ViewModelPropertyChangedListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithValue -= ViewModelPropertyChangedWithValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithBoolValue -= ViewModelPropertyChangedWithBoolValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithIntValue -= ViewModelPropertyChangedWithIntValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithFloatValue -= ViewModelPropertyChangedWithFloatValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithUIntValue -= ViewModelPropertyChangedWithUIntValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithColorValue -= ViewModelPropertyChangedWithColorValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithDoubleValue -= ViewModelPropertyChangedWithDoubleValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithVec2Value -= ViewModelPropertyChangedWithVec2ValueListenerOf_datasource_Root_HandlePieceList;
			if (_datasource_Root_HandlePieceList_Pieces != null)
			{
				_datasource_Root_HandlePieceList_Pieces.ListChanged -= OnList_datasource_Root_HandlePieceList_PiecesChanged;
				for (int num = _widget_0_0_0_1_0.ChildCount - 1; num >= 0; num--)
				{
					...
					((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate)_widget_0_0_0_1_0.GetChild(num)).DestroyDataSource();
				}
				_datasource_Root_HandlePieceList_Pieces = null;
			}
			_datasource_Root_HandlePieceList = null;
		}
		if (_datasource_Root_WeaponFlagIconsList != null)
		{
			...
			for (int num2 = _widget_0_2.ChildCount - 1; num2 >= 0; num2--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate)_widget_0_2.GetChild(num2)).DestroyDataSource();
			}
	...
	private void HandleWidgetPropertyChangeOf_widget_0_4_1(string propertyName)
	{
		...
		{
			_datasource_Root.HandleSize = _widget_0_4_1.ValueInt;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		switch (propertyName)
		{
		case "HandlePieceList":
			RefreshDataSource_datasource_Root_HandlePieceList(_datasource_Root.HandlePieceList);
			break;
		...
		case "ComponentSizeLbl":
			...
			break;
		case "HandleSize":
			_widget_0_4_1.ValueInt = _datasource_Root.HandleSize;
			break;
		}
	}
	...
	{
		HandleViewModelPropertyChangeOf_datasource_Root_HandlePieceList(e.PropertyName);
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_HandlePieceList(string propertyName)
	{
		...
		{
			RefreshDataSource_datasource_Root_HandlePieceList_Pieces(_datasource_Root_HandlePieceList.Pieces);
		}
	}

	public void OnList_datasource_Root_HandlePieceList_PiecesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		{
			for (int i = 0; i < _datasource_Root_HandlePieceList_Pieces.Count; i++)
			{
				CraftingPieceVM bindingObject = _datasource_Root_HandlePieceList_Pieces[i];
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			CraftingPieceVM dataSource = (CraftingPieceVM)(generatedWidgetData.Data = _datasource_Root_HandlePieceList_Pieces[e.NewIndex]);
			...
			_widget_0_0_0_1_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate, e.NewIndex);
	...
	public void OnList_datasource_Root_WeaponFlagIconsListChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(WeaponDesignVM newDataSource)
	{
		...
		_widget_0_4_1.uintPropertyChanged += uintPropertyChangedListenerOf_widget_0_4_1;
		_widget_0_4_1.ColorPropertyChanged += ColorPropertyChangedListenerOf_widget_0_4_1;
		_datasource_Root_HandlePieceList = _datasource_Root.HandlePieceList;
		if (_datasource_Root_HandlePieceList != null)
		{
			_datasource_Root_HandlePieceList.PropertyChanged += ViewModelPropertyChangedListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithValue += ViewModelPropertyChangedWithValueListenerOf_datasource_Root_HandlePieceList;
			...
			_datasource_Root_HandlePieceList.PropertyChangedWithDoubleValue += ViewModelPropertyChangedWithDoubleValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList.PropertyChangedWithVec2Value += ViewModelPropertyChangedWithVec2ValueListenerOf_datasource_Root_HandlePieceList;
			_datasource_Root_HandlePieceList_Pieces = _datasource_Root_HandlePieceList.Pieces;
			if (_datasource_Root_HandlePieceList_Pieces != null)
			{
				_datasource_Root_HandlePieceList_Pieces.ListChanged += OnList_datasource_Root_HandlePieceList_PiecesChanged;
				for (int i = 0; i < _datasource_Root_HandlePieceList_Pieces.Count; i++)
				{
					Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate = new Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate(base.Context);
					GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate);
					CraftingPieceVM dataSource = (CraftingPieceVM)(generatedWidgetData.Data = _datasource_Root_HandlePieceList_Pieces[i]);
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate.AddComponent(generatedWidgetData);
					_widget_0_0_0_1_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate, i);
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate.CreateWidgets();
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate.SetIds();
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate.SetAttributes();
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_37_ItemTemplate.SetDataSource(dataSource);
		...
		if (_datasource_Root_WeaponFlagIconsList != null)
		{
			...
			{
				Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate = new Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData2 = new GeneratedWidgetData(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate);
				ItemFlagVM dataSource2 = (ItemFlagVM)(generatedWidgetData2.Data = _datasource_Root_WeaponFlagIconsList[j]);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.AddComponent(generatedWidgetData2);
				_widget_0_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate, j);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.SetDataSource(dataSource2);
			}
		}
	}
	...
	private void RefreshDataSource_datasource_Root_HandlePieceList(CraftingPieceListVM newDataSource)
	{
		...
		_datasource_Root_HandlePieceList = newDataSource;
		_datasource_Root_HandlePieceList = _datasource_Root.HandlePieceList;
		if (_datasource_Root_HandlePieceList == null)
		{
			return;
	...
	private void RefreshDataSource_datasource_Root_HandlePieceList_Pieces(MBBindingList<CraftingPieceVM> newDataSource)
	{
		...
		_datasource_Root_HandlePieceList_Pieces = newDataSource;
		_datasource_Root_HandlePieceList_Pieces = _datasource_Root_HandlePieceList.Pieces;
		if (_datasource_Root_HandlePieceList_Pieces != null)
		{
			_datasource_Root_HandlePieceList_Pieces.ListChanged += OnList_datasource_Root_HandlePieceList_PiecesChanged;
	...
	private void RefreshDataSource_datasource_Root_WeaponFlagIconsList(MBBindingList<ItemFlagVM> newDataSource)
	{
		...
		if (_datasource_Root_WeaponFlagIconsList != null)
		{
			...
			for (int i = 0; i < _datasource_Root_WeaponFlagIconsList.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_38_ItemTemplate.SetDataSource(dataSource);
