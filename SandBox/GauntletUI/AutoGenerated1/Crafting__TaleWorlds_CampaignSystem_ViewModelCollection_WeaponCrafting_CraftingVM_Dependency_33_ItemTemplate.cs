...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_33_ItemTemplate : Widget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_ItemAttributeIcons != null)
		{
			...
			for (int num = _widget_0_0_4.ChildCount - 1; num >= 0; num--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate)_widget_0_0_4.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_ItemAttributeIconsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_4.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate, e.NewIndex);
			...
			crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_0_0_4.GetChild(e.NewIndex);
			((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_0_0_4.GetChild(e.NewIndex);
			((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(CraftingPieceVM newDataSource)
	{
		...
		if (_datasource_Root_ItemAttributeIcons != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ItemAttributeIcons.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_4.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_48_ItemTemplate.SetDataSource(dataSource);
