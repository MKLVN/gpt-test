...
public class SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_6_SPScoreboardSide__DependendPrefab : Widget
{
	...
	public SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_6_SPScoreboardSide__DependendPrefab(UIContext context)
		: base(context)
	{
	}
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_Parties != null)
		{
			...
			for (int num = _widget_0_0_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate)_widget_0_0_0.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_PartiesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_0.AddChildAtIndex(sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(SPScoreboardSideVM newDataSource)
	{
		...
		if (_datasource_Root_Parties != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Parties.Count; i++)
			{
				...
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_0.AddChildAtIndex(sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate, i);
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.CreateWidgets();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetIds();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetAttributes();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate.SetDataSource(dataSource);
