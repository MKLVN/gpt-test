...
public class QuestsScreen__TaleWorlds_CampaignSystem_ViewModelCollection_Quests_QuestsVM_Dependency_3_ItemTemplate : QuestItemButtonWidget
{
	...
	public void SetAttributes()
	{
		...
		_widget_0_2.SuggestedWidth = 29f;
		_widget_0_2.SuggestedHeight = 29f;
		_widget_0_2.VerticalAlignment = VerticalAlignment.Center;
		_widget_0_2.Sprite = base.Context.SpriteData.GetSprite("Quest\\text_ball_ring");
		_widget_0_2.AlphaFactor = 0.8f;
		_widget_0_2.Color = new Color(0.9568628f, 0.882353f, 0.7686275f);
	...
	private void HandleWidgetPropertyChangeOf_widget_0_2(string propertyName)
	{
		if (propertyName == "IsVisible")
		{
			_datasource_Root.IsUpdated = _widget_0_2.IsVisible;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		case "Name":
			...
			break;
		case "IsUpdated":
			_widget_0_2.IsVisible = _datasource_Root.IsUpdated;
			break;
