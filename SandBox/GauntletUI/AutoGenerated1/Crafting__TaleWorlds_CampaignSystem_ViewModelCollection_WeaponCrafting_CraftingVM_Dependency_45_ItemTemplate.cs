...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate : QuestMarkerBrushWidget
{
	private QuestMarkerBrushWidget _widget;

	private QuestMarkerVM _datasource_Root;

	public Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate(UIContext context)
		: base(context)
	{
	}
