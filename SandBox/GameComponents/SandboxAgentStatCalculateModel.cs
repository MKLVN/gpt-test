...
public class SandboxAgentStatCalculateModel : AgentStatCalculateModel
{
	...
	private void UpdateHumanStats(Agent agent, AgentDrivenProperties agentDrivenProperties)
	{
		...
		float num8 = TaleWorlds.Library.MathF.Max(0.2f * (1f - DefaultSkillEffects.AthleticsWeightFactor.GetPrimaryValue(effectiveSkill) * 0.01f), 0f) * num2 / (float)weight;
		...
		GetSkillEffectsOnAgent(agent, agentDrivenProperties, weaponComponentData);
		GetPerkAndBannerEffectsOnAgent(agent, agentDrivenProperties, weaponComponentData);
		...
		if (!agent.Mission.Scene.IsAtmosphereIndoor)
		{
			...
			{
				num11 += TaleWorlds.Library.MathF.Min(0.3f, rainDensity + fog);
			}
	...
	private void GetPerkAndBannerEffectsOnAgent(Agent agent, AgentDrivenProperties agentDrivenProperties, WeaponComponentData rightHandEquippedItem)
	{
		...
		bool flag = rightHandEquippedItem?.IsRangedWeapon ?? false;
		bool flag2 = rightHandEquippedItem?.IsMeleeWeapon ?? false;
		...
		PerkHelper.AddPerkBonusForCharacter(DefaultPerks.OneHanded.FleetOfFoot, characterObject, isPrimaryBonus: true, ref bonuses);
		ExplainedNumber bonuses3 = new ExplainedNumber(agentDrivenProperties.KickStunDurationMultiplier);
		PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Roguery.DirtyFighting, characterObject, isPrimaryBonus: true, ref bonuses3);
		...
		if (rightHandEquippedItem != null)
		{
			...
			if (flag2)
			{
				...
				if (!agent.HasMount)
				{
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Athletics.Fury, characterObject, isPrimaryBonus: true, ref bonuses6);
					if (characterObject2 != null)
					{
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Athletics.Fury, characterObject2, ref bonuses6);
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.TwoHanded.OnTheEdge, characterObject2, ref bonuses5);
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.TwoHanded.BladeMaster, characterObject2, ref bonuses5);
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Polearm.SwiftSwing, characterObject2, ref bonuses5);
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.TwoHanded.BladeMaster, characterObject2, ref bonuses4);
					}
				}
				if (rightHandEquippedItem.RelevantSkill == DefaultSkills.OneHanded)
				{
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.OneHanded.SwiftStrike, characterObject, isPrimaryBonus: true, ref bonuses5);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.OneHanded.WayOfTheSword, characterObject, DefaultSkills.OneHanded, applyPrimaryBonus: true, ref bonuses5, Campaign.Current.Models.CharacterDevelopmentModel.MaxSkillRequiredForEpicPerkBonus);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.OneHanded.WayOfTheSword, characterObject, DefaultSkills.OneHanded, applyPrimaryBonus: true, ref bonuses4, Campaign.Current.Models.CharacterDevelopmentModel.MaxSkillRequiredForEpicPerkBonus);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.OneHanded.WrappedHandles, characterObject, isPrimaryBonus: true, ref bonuses6);
				}
				else if (rightHandEquippedItem.RelevantSkill == DefaultSkills.TwoHanded)
				{
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.TwoHanded.OnTheEdge, characterObject, isPrimaryBonus: true, ref bonuses5);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.TwoHanded.WayOfTheGreatAxe, characterObject, DefaultSkills.TwoHanded, applyPrimaryBonus: true, ref bonuses5, Campaign.Current.Models.CharacterDevelopmentModel.MaxSkillRequiredForEpicPerkBonus);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.TwoHanded.WayOfTheGreatAxe, characterObject, DefaultSkills.TwoHanded, applyPrimaryBonus: true, ref bonuses4, Campaign.Current.Models.CharacterDevelopmentModel.MaxSkillRequiredForEpicPerkBonus);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.TwoHanded.StrongGrip, characterObject, isPrimaryBonus: true, ref bonuses6);
				}
				else if (rightHandEquippedItem.RelevantSkill == DefaultSkills.Polearm)
				{
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Polearm.Footwork, characterObject, isPrimaryBonus: true, ref bonuses);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Polearm.SwiftSwing, characterObject, isPrimaryBonus: true, ref bonuses5);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.Polearm.WayOfTheSpear, characterObject, DefaultSkills.Polearm, applyPrimaryBonus: true, ref bonuses5, Campaign.Current.Models.CharacterDevelopmentModel.MaxSkillRequiredForEpicPerkBonus);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.Polearm.WayOfTheSpear, characterObject, DefaultSkills.Polearm, applyPrimaryBonus: true, ref bonuses4, Campaign.Current.Models.CharacterDevelopmentModel.MaxSkillRequiredForEpicPerkBonus);
					if (rightHandEquippedItem.SwingDamageType != DamageTypes.Invalid)
					{
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Polearm.CounterWeight, characterObject, isPrimaryBonus: true, ref bonuses6);
					}
				}
			...
			if (flag)
			{
				...
				PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.NockingPoint, characterObject, isPrimaryBonus: true, ref bonuses13);
				if (characterObject2 != null)
				{
					PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Crossbow.LooseAndMove, characterObject2, ref bonuses2);
				}
				if (activeBanner != null)
				{
				...
				if (agent.HasMount)
				{
					...
					{
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Riding.Sagittarius, characterObject, isPrimaryBonus: true, ref bonuses8);
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Riding.Sagittarius, characterObject, isPrimaryBonus: true, ref bonuses9);
					}
					if (characterObject2 != null && characterObject2.GetPerkValue(DefaultPerks.Riding.Sagittarius))
					{
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Riding.Sagittarius, characterObject2, ref bonuses8);
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Riding.Sagittarius, characterObject2, ref bonuses9);
					}
					if (rightHandEquippedItem.RelevantSkill == DefaultSkills.Bow && characterObject.GetPerkValue(DefaultPerks.Bow.MountedArchery))
					{
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.MountedArchery, characterObject, isPrimaryBonus: true, ref bonuses8);
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.MountedArchery, characterObject, isPrimaryBonus: true, ref bonuses9);
					}
					...
					{
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Throwing.MountedSkirmisher, characterObject, isPrimaryBonus: true, ref bonuses8);
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Throwing.MountedSkirmisher, characterObject, isPrimaryBonus: true, ref bonuses9);
					}
				}
				bool flag4 = false;
				...
				{
					flag4 = true;
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.BowControl, characterObject, isPrimaryBonus: true, ref bonuses8);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.RapidFire, characterObject, isPrimaryBonus: true, ref bonuses14);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.QuickAdjustments, characterObject, isPrimaryBonus: true, ref bonuses10);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.Discipline, characterObject, isPrimaryBonus: true, ref bonuses11);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.Discipline, characterObject, isPrimaryBonus: true, ref bonuses12);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Bow.QuickDraw, characterObject, isPrimaryBonus: true, ref bonuses4);
					if (characterObject2 != null)
					{
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Bow.RapidFire, characterObject2, ref bonuses14);
						if (!agent.HasMount)
						{
							PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Bow.NockingPoint, characterObject2, ref bonuses2);
						}
					}
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.Bow.Deadshot, characterObject, DefaultSkills.Bow, applyPrimaryBonus: true, ref bonuses14, Campaign.Current.Models.CharacterDevelopmentModel.MinSkillRequiredForEpicPerkBonus);
				}
				else if (rightHandEquippedItem.RelevantSkill == DefaultSkills.Crossbow)
				{
					...
					if (agent.HasMount)
					{
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Crossbow.Steady, characterObject, isPrimaryBonus: true, ref bonuses8);
						PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Crossbow.Steady, characterObject, isPrimaryBonus: true, ref bonuses10);
					}
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Crossbow.WindWinder, characterObject, isPrimaryBonus: true, ref bonuses14);
					if (characterObject2 != null)
					{
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Crossbow.WindWinder, characterObject2, ref bonuses14);
					}
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Crossbow.DonkeysSwiftness, characterObject, isPrimaryBonus: true, ref bonuses8);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Crossbow.Marksmen, characterObject, isPrimaryBonus: true, ref bonuses4);
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.Crossbow.MightyPull, characterObject, DefaultSkills.Crossbow, applyPrimaryBonus: true, ref bonuses14, Campaign.Current.Models.CharacterDevelopmentModel.MinSkillRequiredForEpicPerkBonus);
				}
				else if (rightHandEquippedItem.RelevantSkill == DefaultSkills.Throwing)
				{
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Throwing.QuickDraw, characterObject, isPrimaryBonus: true, ref bonuses14);
					PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Throwing.PerfectTechnique, characterObject, isPrimaryBonus: true, ref bonuses15);
					if (characterObject2 != null)
					{
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Throwing.QuickDraw, characterObject2, ref bonuses14);
						PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Throwing.PerfectTechnique, characterObject2, ref bonuses15);
					}
					PerkHelper.AddEpicPerkBonusForCharacter(DefaultPerks.Throwing.UnstoppableForce, characterObject, DefaultSkills.Throwing, applyPrimaryBonus: true, ref bonuses15, Campaign.Current.Models.CharacterDevelopmentModel.MinSkillRequiredForEpicPerkBonus);
				}
		...
		if (flag3)
		{
			...
			if (characterObject2 != null)
			{
				...
				{
					PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.OneHanded.ShieldWall, characterObject2, ref bonuses16);
				}
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.OneHanded.ArrowCatcher, characterObject2, ref bonuses16);
			}
			PerkHelper.AddPerkBonusForCharacter(DefaultPerks.OneHanded.ArrowCatcher, characterObject, isPrimaryBonus: true, ref bonuses16);
			...
			PerkHelper.AddPerkBonusForCharacter(DefaultPerks.OneHanded.Basher, characterObject, isPrimaryBonus: true, ref bonuses17);
			agentDrivenProperties.ShieldBashStunDurationMultiplier = bonuses17.ResultNumber;
		}
		else
		{
			PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Athletics.MorningExercise, characterObject, isPrimaryBonus: true, ref bonuses2);
			PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Medicine.SelfMedication, characterObject, isPrimaryBonus: false, ref bonuses2);
			if (!(flag3 || flag))
			{
				PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Athletics.Sprint, characterObject, isPrimaryBonus: true, ref bonuses2);
			}
			if (rightHandEquippedItem == null && itemObject == null)
			{
				PerkHelper.AddPerkBonusForCharacter(DefaultPerks.Roguery.FleetFooted, characterObject, isPrimaryBonus: true, ref bonuses2);
			}
			if (characterObject2 != null)
			{
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Athletics.MorningExercise, characterObject2, ref bonuses2);
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.OneHanded.ShieldBearer, characterObject2, ref bonuses2);
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.OneHanded.FleetOfFoot, characterObject2, ref bonuses2);
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.TwoHanded.RecklessCharge, characterObject2, ref bonuses2);
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Polearm.Footwork, characterObject2, ref bonuses2);
				if (characterObject.Tier >= 3)
				{
					PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Athletics.FormFittingArmor, characterObject2, ref bonuses2);
				}
				if (characterObject.IsInfantry)
				{
					PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Athletics.Sprint, characterObject2, ref bonuses2);
				}
			}
		}
		if (agent.IsHero)
		{
			ItemObject item = (Mission.Current.DoesMissionRequireCivilianEquipment ? characterObject.FirstCivilianEquipment : characterObject.FirstBattleEquipment)[EquipmentIndex.Body].Item;
		...
		if (Mission.Current != null && Mission.Current.HasValidTerrainType)
		{
			...
			case TerrainType.Forest:
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Tactics.ExtendedSkirmish, characterObject2, ref bonuses2);
				break;
			case TerrainType.Steppe:
			case TerrainType.Plain:
			case TerrainType.Desert:
				PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Tactics.DecisiveBattle, characterObject2, ref bonuses2);
				break;
			}
		}
		...
		{
			PerkHelper.AddPerkBonusFromCaptain(DefaultPerks.Tactics.SmallUnitTactics, characterObject2, ref bonuses2);
		}
		if (activeBanner != null)
		{
	...
	private void GetSkillEffectsOnAgent(Agent agent, AgentDrivenProperties agentDrivenProperties, WeaponComponentData rightHandEquippedItem)
	{
		...
		{
			int effectiveSkill = GetEffectiveSkill(agent, rightHandEquippedItem.RelevantSkill);
			...
			{
				int effectiveSkill2 = GetEffectiveSkill(agent, DefaultSkills.Riding);
				float value = -0.01f * TaleWorlds.Library.MathF.Max(0f, DefaultSkillEffects.HorseWeaponSpeedPenalty.GetPrimaryValue(effectiveSkill2));
